...
Convoluções, pooling, arquiteturas clássicas. Notebooks combinam explicação visual + implementação comentada.
...
Cada notebook segue o padrão: **conceito teórico em PT-BR → equações → implementação comentada → experimento**. Útil como referência e como template de código reutilizável.
